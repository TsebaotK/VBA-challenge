 ...
 For i = 2 To total_row
    If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
        ...
        ws.Cells(output_row, 11).NumberFormat = "0.00%"
          ...
          stock_amount = stock_amount + Cells(i, 7).Value
...
row_count = Cells(Rows.Count, 9).End(xlUp).Row
...
ws.Cells(4, 15).Value = "Greatest Total Volume"
  ...
  ws.Range("Q2").Value = WorksheetFunction.Max(ws.Range("K2:K" & row_count))
  ws.Range("Q2").NumberFormat = "0.00%"

  
  ws.Range("Q3").Value = WorksheetFunction.Min(ws.Range("K2:k" & row_count))
  ws.Range("Q3").NumberFormat = "0.00%"

  ws.Range("Q4").Value = WorksheetFunction.Max(ws.Range("L2:L" & row_count))
